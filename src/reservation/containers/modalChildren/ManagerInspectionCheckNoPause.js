...
class ManagerInspectionCheckNoPause extends Component {
	constructor(props) {
		super(props)
		this.state = {
			loading: true,
			...
			<Spin spinning={this.state.loading} >
				...
				<Form>
					...
					<FormItem
						...
						{...formItemLayout}
					>
						{managerInspectionCheckData.paused_comment}
					</FormItem>
					<Divider />
					{
...
ManagerInspectionCheckNoPause.propTypes = {
...
export default connect(
	...
	mapDispatchToProps
)(Form.create()(ManagerInspectionCheckNoPause))
